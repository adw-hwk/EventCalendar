...
<div class="hero-wrapper">
    ...
    <div class="hero-article-wrapper">
        ...
        <img src="<?php echo get_template_directory_uri() . '/img/046.jpg' ?>" alt="">

        <div class="hero-title">SA Awards</div><br>
    ...
    <div class="hero-text-wrapper">
        ...
        <h1>What'll you be doing in February?</h1>
        ...
        <div class="details">
            ...
            <div>
                ...
                <div style="padding: 2rem;background-color:rgba(255,255,255,0.85);display:inline-block;margin:auto;border-radius: 8px;">
                    ...
                    <div class="time"><i class="far fa-clock"></i> 7:00pm - 9:30pm</div><br>
