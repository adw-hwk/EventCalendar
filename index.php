...
<div id="page-wrapper">
    ...
    <img src="<?php echo get_template_directory_uri() . '/img/logo-white.png' ?>" alt="" class="header-logo">
            ...
            <div class="swiper-container month-text-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="month-text-slide swiper-slide" id="january-month-text">
                        <span><strong><?php echo date('Y'); ?> |</strong> January</span>
                    </div>
        ...
        <div class="months-dropdown-menu">
            ...
            <div class="month">
                <div class="banner">01 <span> | <strong><?php echo date('Y'); ?></strong> | January</span></div>
                ...
                <div class="hero-wrapper">
                    ...
                    <div class="hero-text-wrapper">
                        ...
                        <div class="text">
                            ...
                            <div class="counter"><?php echo count($events); ?></div>
                            <div class="hero-blurb">
                                <div>First National events scheduled for <?php echo date('Y'); ?>.</div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/february.jpg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/march.jpeg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/april.jpeg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/may.jpeg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/june.jpeg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/july.jpg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/august.jpg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/september.jpeg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/october.jpg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/november.jpg' ?>" alt="">
                        </div>
...
<div class="arrow"><i class="fas fa-angle-down"></i></div>
                            ...
                            <img class="hero-bg-image" src="<?php echo get_template_directory_uri() . '/img/december.jpg' ?>" alt="">
                        </div>
